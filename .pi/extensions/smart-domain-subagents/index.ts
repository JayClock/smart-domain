...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    description: [
      ...
      "Use for scenario-first, association-first planning across Domain, Persistent, HTTP interface, agent-tree, and test boundaries.",
    ...
    promptGuidelines: [
      "Use smart_domain_subagent with smart-domain-architect first to produce scenarios, concrete data, roots, association and role matrices, and layer impact before editing.",
      "Reject service-first designs; business behavior must enter through a root association, entity, or context role.",
      "Call only affected specialist agents for Domain, Persistent, HTTP interface, agent-tree, or test analysis.",
      "Use chain mode when contracts are unclear; domain graph analysis must precede persistence or API design.",
