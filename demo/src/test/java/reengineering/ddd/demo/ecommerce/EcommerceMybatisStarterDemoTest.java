...
import reengineering.ddd.demo.ecommerce.mybatis.config.EcommerceDemoSmartDomainMybatisConfiguration;

class EcommerceMybatisStarterDemoTest {
  ...
  void should_register_ecommerce_demo_mybatis_configuration_from_annotation() throws Exception {
    try (AnnotationConfigApplicationContext context =
      ...
      assertEquals(
          List.of("reengineering.ddd.demo.ecommerce.mybatis"),
