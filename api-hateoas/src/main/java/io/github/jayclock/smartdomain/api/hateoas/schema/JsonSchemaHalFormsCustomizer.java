...
public class JsonSchemaHalFormsCustomizer implements HalFormsOptionsCustomizer {
  ...
  public JsonSchemaHalFormsCustomizer(
      JsonSchemaService schemaService, ObjectMapper objectMapper, Collection<String> scanPackages) {
    this.schemaService = schemaService;
    this.bindings = discoverBindings(scanPackages);
  ...
  private List<SchemaBinding> discoverBindings(Collection<String> scanPackages) {
  ...
  private void collectBindings(
    ...
    for (Field field : type.getDeclaredFields()) {
      ...
      addBinding(
          ...
          new SchemaBinding(type, resolvePropertyName(field), annotation.value()));
    }
    ...
    if (type.isRecord()) {
      for (RecordComponent component : type.getRecordComponents()) {
        ...
        addBinding(
            discovered,
            deduplicatedBindings,
            new SchemaBinding(type, resolvePropertyName(component), annotation.value()));
      }
    }
