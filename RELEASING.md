...
cd smart-domain
./gradlew --no-parallel -PsmartDomainVersion=0.3.0 publishReleaseBundle
```

## GitHub Release Flow

The standalone repository workflow publishes when a tag like `v0.3.0` is pushed or when the
